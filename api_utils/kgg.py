...
def createKG(disease_id,phase,protein_threshold):
    ...
    drugs_df = GetDiseaseAssociatedDrugs(doid['id'][id],ct_phase)
    
    dis2prot_df = GetDiseaseAssociatedProteins(doid['id'][id])
    
    dis2snp_df= GetDiseaseSNPs(doid['id'][id]) 
